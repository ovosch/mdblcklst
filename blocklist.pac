...
var blackhole_ip_port = "127.0.0.1:8000";    // on iOS a working blackhole requires return code 200;
...
"ytprivate.com": null,
"invidious.io": null,
"redirect.invidious.io": null,
"invidious.snopyta.org": null,
"vid.mint.lgbt": null,
"bibliogram.snopyta.org": null,
"invidious.fdn.fr": null,
"tube.connect.cafe": null,
"inv.skyn3t.in": null,
"invidious.himiko.cloud": null,
"vid.puffyan.us": null,
"invidious.namazso.eu": null,
"tube.incog.host": null,
"invidious.048596.xyz": null,
"invidious.kavin.rocks": null,
"invidious.zee.li": null,
"genmirror.com": null,
"itiqua.today": null,
...
var bad_da_host_RegExp = /^(?:[\w-]+\.)*?(?:tracker(?=([\s\S]*?\.richcasino\.com))\1|imgadult\.com(?=([\s\S]*?))\2|imgtaxi\.com(?=([\s\S]*?))\3|instagram\.(?=([\s\S]*?\.fna\.fbcdn\.net))\4|images\.(?=([\s\S]*?\.criteo\.net))\5|analytics\-beacon\-(?=([\s\S]*?\.amazonaws\.com))\6|imgdrive\.net(?=([\s\S]*?))\7|rcm(?=([\s\S]*?\.amazon\.))\8|stats\-(?=([\s\S]*?\.p2pnow\.ru))\9|instagram\.*\.fna\.fbcdn\.net)/i;
